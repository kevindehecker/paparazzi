 ...
 */
/**
 * @file "modules/vertxesc/vertxesc.c"
 * @author Kevin van Hecke
 * Driver for the vert-x vtol escs
 */

#include "modules/vertxesc/vertxesc.h"
...
#include "/home/houjebek/paparazzi/sw/airborne/arch/chibios/subsystems/actuators/actuators_pwm_arch.h"
#include "led.h"
...
void vertx_esc_init(void) {

}

uint32_t m1 = 1160;
uint32_t m2 = 1160+300;

void vertx_esc_periodic(void) {
    m1 +=1;
    if (m1 > 1880)
        m1 = 1250;
    m2 +=1;
    ...
    package.d1 =actuators_pwm_values[PWM_SERVO_0];
    package.d2 =actuators_pwm_values[PWM_SERVO_1];
