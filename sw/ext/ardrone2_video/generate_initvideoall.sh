...
echo "gst-launch v4l2src device=/dev/video2 ! mavlab mode=3 ! ffmpegcolorspace ! dspmp4venc ! rtpmp4vpay config-interval=2 ! udpsink host=$ip port=5000 > /dev/null 2>&1 &" >> $1/initvideoall.sh
